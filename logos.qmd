...
sticker(p_econometrics,           # Subplot
        ...
        dpi = 300,
        filename = "logos_png/econometrics_logo.png") # ggsave() will override the default png on this line.

# Save the sticker as a rectangle (keeps original dimension ratio of hexagon):
ggsave(filename = "logos_png/econometrics_logo.png",
       width = 2072, height = 2400, units = "px",
       bg = "transparent",
       dpi = 300)

# Save the sticker as a square:
ggsave(filename = "logos_png/econometrics_logo_square.png",
...
sticker(p_researchecon,                               # Subplot
        ...
        h_color = "#FCCE09",                          # Hex border color
        dpi = 300,
        filename = "logos_png/research_methods_in_economics_logo.png") # ggsave() will override the default png on this line.

# Save the sticker as a rectangle (keeps original dimension ratio of hexagon):
ggsave(filename = "logos_png/research_methods_in_economics_logo.png",
       width = 2072, height = 2400, units = "px",
       bg = "transparent",
       dpi = 300)

# Save the sticker as a square:
ggsave(filename = "logos_png/research_methods_in_economics_logo_square.png",
       width = 2400, height = 2400, units = "px",
       bg = "transparent",
       dpi = 300)
```
